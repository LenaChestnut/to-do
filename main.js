...
/*!********************************!*\
  !*** ./src/domManipulation.js ***!
  \********************************/
/*! exports provided: elements, toggleMenuPanel, isMenuOpen, loadTaskView, expandTaskCard, collapseTaskCard, changeToCollapse, changeToExpand, updateProjectList, projectCardModule, removeNode, hideElement, showElement, showOverlay, hideOverlay */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadTaskView", function() { return loadTaskView; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "expandTaskCard", function() { return expandTaskCard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "collapseTaskCard", function() { return collapseTaskCard; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeToCollapse", function() { return changeToCollapse; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "changeToExpand", function() { return changeToExpand; });
...
/* harmony import */ var _formController_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./formController.js */ "./src/formController.js");
/* harmony import */ var _eventHandlers_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./eventHandlers.js */ "./src/eventHandlers.js");
...
elements.newTaskBtn.classList.add('new-task-btn'); // MENU PANEL
...
function loadTaskView(requestedTasks) {
  var sortedTasks = sortTasks(requestedTasks);
...
function sortTasks(tasksArr) {
  var tasksByPriority = tasksArr.sort(function (task1, task2) {
  ...
  var tasksByDate = tasksByPriority.sort(function (task1, task2) {
...
function buildTaskCard(task) {
  ...
  var expandBtn = Object(_formController_js__WEBPACK_IMPORTED_MODULE_2__["createButton"])('button', '../dist/assets/chevron-down.svg', '', 'expand-btn');
  ...
  if (Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["isToday"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["parseISO"])(task.dueDate))) {
    taskDate.textContent = 'Due: Today';
  } else if (Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["isTomorrow"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["parseISO"])(task.dueDate))) {
    taskDate.textContent = 'Due: Tomorrow';
  } else {
    taskDate.textContent = 'Due: ' + Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["format"])(Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["parseISO"])(task.dueDate), 'PPP');
  }
  ...
  checkbox.setAttribute('id', "".concat(checkId));
  taskCard.appendChild(checkbox);
  var label = document.createElement('label');
  label.setAttribute('for', "".concat(checkId));
  taskCard.appendChild(label);
  cardContainer.appendChild(taskCard);
  elements.taskList.appendChild(cardContainer);
  pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish('Load task card', {
    card: cardContainer,
    expandBtn: expandBtn,
    checkbox: checkbox,
    task: task
...
function expandTaskCard(task, card) {
  var expandedInfoContainer = document.createElement('div');
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_0___default.a.publish('Task expanded', {
    editButton: editTask,
    task: task
  });
}
function collapseTaskCard(card) {
  card.removeChild(card.lastChild);
}
function changeToCollapse(button) {
  button.setAttribute('class', 'collapse-btn');
}
function changeToExpand(button) {
  button.setAttribute('class', 'expand-btn');
} // PROJECTS VIEW

function appendProjectCards() {
  var projects = Object(_storage_js__WEBPACK_IMPORTED_MODULE_1__["getProjects"])();

  for (var i = 0; i < projects.length; i++) {
    projectCardModule.buildCard(projects[i].name, i);
  }

  var projectCards = projectCardModule.getProjectCards();
  projectCards[_eventHandlers_js__WEBPACK_IMPORTED_MODULE_3__["currentProject"]].classList.add('selected-project');
...
var projectCardModule = function () {
...
/*!******************************!*\
  !*** ./src/eventHandlers.js ***!
  \******************************/
/*! exports provided: currentProject, default */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
var eventHandler = function () {
  ...
  _domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["elements"].homeBtn.addEventListener('click', function () {
    pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.publish('Change active project', {
      projectIndex: 0
    });
  }); // PROJECT MENU EVENTS
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.subscribe("View projects", function () {
    var projectCards = _domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["projectCardModule"].getProjectCards();
    ...
    var _loop = function _loop(i) {
      projectCards[i].addEventListener('click', function (e) {
        ...
        if (target.tagName.toLowerCase() === 'button') {
          var targetClass = getTargetClass(target);

          if (targetClass === 'edit') {
            Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["showOverlay"])();
            setTimeout(function () {
              Object(_formController_js__WEBPACK_IMPORTED_MODULE_1__["createProjectForm"])(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["elements"].container, 'edit-project', i);
            }, 150);
          } else if (targetClass === 'remove') {
            var userConfirm = confirm("Are you sure? You won't be able to cancel this action.");

            if (userConfirm) {
              Object(_storage_js__WEBPACK_IMPORTED_MODULE_3__["removeProject"])(i);
            }
          }
        } else {
          pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.publish('Change active project', {
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.subscribe('Change active project', function (tag, data) {
    currentProject = data.projectIndex;
    var projectCards = _domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["projectCardModule"].getProjectCards();
    var currentProjectTasks = Object(_storage_js__WEBPACK_IMPORTED_MODULE_3__["getProjectTasks"])(data.projectIndex);
    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["loadTaskView"])(currentProjectTasks);

    if (Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["isMenuOpen"])()) {
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.subscribe('Update storage', function () {
    if (Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["isMenuOpen"])()) {
      Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["updateProjectList"])();
    }

    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["loadTaskView"])(Object(_storage_js__WEBPACK_IMPORTED_MODULE_3__["getProjectTasks"])(currentProject));
  }); // FORM EVENTS

  _domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["elements"].newProjectBtn.addEventListener('click', function () {
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.subscribe('Create form', function (tag, data) {
    ...
    form.addEventListener('click', function (e) {
      ...
      if (target.tagName.toLowerCase() === 'button') {
        ...
        if (targetClass === 'save') {
          e.preventDefault();
          Object(_formController_js__WEBPACK_IMPORTED_MODULE_1__["handleSubmit"])(form);
        } else if (targetClass === 'cancel') {
          Object(_formController_js__WEBPACK_IMPORTED_MODULE_1__["handleCancel"])(form);
        }
      }
  ...
  _domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["elements"].newTaskBtn.addEventListener('click', function () {
    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["showOverlay"])();
    setTimeout(function () {
      Object(_formController_js__WEBPACK_IMPORTED_MODULE_1__["createTaskForm"])(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["elements"].container, 'new-task');
    }, 150);
  }); // Assign events to controls of newly created task card

  pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.subscribe('Load task card', function (tag, data) {
    var taskExpanded = false;
    data.expandBtn.addEventListener('click', function () {
      if (taskExpanded) {
        taskExpanded = false;
        Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["changeToExpand"])(data.expandBtn);
        Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["collapseTaskCard"])(data.card);
      } else {
        taskExpanded = true;
        Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["changeToCollapse"])(data.expandBtn);
        Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["expandTaskCard"])(data.task, data.card);
      }
    });
    data.checkbox.addEventListener('click', function () {
      Object(_storage_js__WEBPACK_IMPORTED_MODULE_3__["removeTask"])(data.task.project, data.task.index);
    });
  });
  pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.subscribe('Task expanded', function (tag, data) {
    data.editButton.addEventListener('click', function () {
      Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["showOverlay"])();
      setTimeout(function () {
        Object(_formController_js__WEBPACK_IMPORTED_MODULE_1__["createTaskForm"])(_domManipulation_js__WEBPACK_IMPORTED_MODULE_0__["elements"].container, 'edit-task', data.task);
      }, 150);
    });
  });
}();
...
/*!*******************************!*\
  !*** ./src/formController.js ***!
  \*******************************/
/*! exports provided: createButton, createProjectForm, createTaskForm, validateInput, getFormInput, changeSaveButtonState, getSaveButton, handleSubmit, handleCancel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _taskController_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./taskController.js */ "./src/taskController.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/index.js");
/* harmony import */ var _eventHandlers_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./eventHandlers.js */ "./src/eventHandlers.js");
...
function createFormContainer(name) {
  ...
  form.setAttribute('name', "".concat(name));
  return form;
}

function createInput(type, name) {
  var input = document.createElement('input');
  input.setAttribute('type', "".concat(type));
  input.setAttribute('name', "".concat(name));
  return input;
}
...
function createSelect(selectName) {
  ...
  if (selectName === 'project-select') {
    var projects = Object(_storage_js__WEBPACK_IMPORTED_MODULE_0__["getProjects"])();
    ...
    for (var i = 0; i < projects.length; i++) {
      ...
      if (_eventHandlers_js__WEBPACK_IMPORTED_MODULE_5__["currentProject"] === i) {
    ...
    for (var j = 3; j >= 1; j--) {
      ...
      _option.value = j;
      _option.textContent = j === 1 ? 'High priority' : j === 2 ? 'Medium priority' : 'Low priority';
...
function createButton(type, source, text, btnClass) {
  ...
  button.setAttribute('type', "".concat(type));
  var icon = document.createElement('img');
  button.setAttribute('class', "".concat(btnClass));
  icon.setAttribute('src', "".concat(source));
  icon.setAttribute('alt', "".concat(text));
...
function createProjectForm(container, name) {
  ...
  var form = createFormContainer(name);
  var projectNameField = createInput('text', 'project-name');
  projectNameField.setAttribute('placeholder', 'Project name');
  projectNameField.required = true;
  var saveBtn = createButton('submit', '../dist/assets/plus.svg', 'save', 'save');
  var cancelBtn = createButton('reset', '../dist/assets/x.svg', 'cancel', 'cancel');
  ...
  if (name === 'edit-project') {
    ...
    var project = Object(_storage_js__WEBPACK_IMPORTED_MODULE_0__["getProjectAtIndex"])(index);
...
;
function createTaskForm(container, name) {
  var task = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
  var form = createFormContainer(name);
  form.classList.add('task-form');
  var taskTitleField = createInput('text', 'task-title');
  ...
  var projectSelect = createSelect('project-select');
  var priorityLabel = document.createElement('p');
  priorityLabel.textContent = 'Priority';
  var prioritySelect = createSelect('priority-select');
  var dueDate = createInput('date', 'due-date');
  dueDate.setAttribute('min', Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["format"])(Date.now(), "yyyy-MM-dd"));
  dueDate.setAttribute('value', Object(date_fns__WEBPACK_IMPORTED_MODULE_4__["format"])(Date.now(), "yyyy-MM-dd"));
  dueDate.required = true;
  var saveBtn = createButton('submit', '../dist/assets/plus.svg', 'save', 'save');
  var cancelBtn = createButton('reset', '../dist/assets/x.svg', 'cancel', 'cancel');

  if (name === 'edit-task') {
    form.setAttribute('id', "P".concat(task.project, "I").concat(task.index));
    var formTitle = document.createElement('h2');
    formTitle.textContent = "Edit task";
    form.appendChild(formTitle);
    taskTitleField.value = "".concat(task.title);
    taskDescription.value = "".concat(task.description);
    projectSelect.value = task.project;
    prioritySelect.value = task.priority;
    dueDate.value = task.dueDate;
  } else if (name === 'new-task') {
    var _formTitle = document.createElement('h2');

    _formTitle.textContent = "New task";
    form.appendChild(_formTitle);
  }
...
function validateInput(form) {
  ...
  var requiredInputs = formElements.filter(function (item) {
    return item.required ? true : false;
  });
  return requiredInputs.every(function (input) {
...
function getFormInput(formName) {
  var form = document.forms["".concat(formName)];
...
function getSaveButton(form) {
  var formElements = getFormElements(form);
  var saveBtnArr = formElements.filter(function (item) {
    if (item.type === 'submit') {
      return item;
    }
  });
  var saveBtn = saveBtnArr[0];
  return saveBtn;
}
function handleSubmit(form) {
  ...
  if (formName === 'project-form' || formName === 'edit-project') {
    if (Object(_storage_js__WEBPACK_IMPORTED_MODULE_0__["getProjectByName"])(getFormInput(formName))) {
  ...
  if (formName === 'project-form') {
    var projectName = getFormInput(formName);
    var project = Object(_projectController_js__WEBPACK_IMPORTED_MODULE_2__["default"])(projectName);
    Object(_storage_js__WEBPACK_IMPORTED_MODULE_0__["addProject"])(project);
    form.reset();
    changeSaveButtonState(form);
  } else if (formName === 'edit-project') {
    var _projectName = getFormInput(formName);

    var projectIndex = Number(form.id);
    Object(_storage_js__WEBPACK_IMPORTED_MODULE_0__["editProject"])(projectIndex, _projectName);
    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["hideOverlay"])();
    setTimeout(function () {
      Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["removeNode"])(form);
    }, 150);
  } else if (formName === 'new-task') {
    var input = getFormInput(formName);
    var task = Object(_taskController_js__WEBPACK_IMPORTED_MODULE_3__["default"])(input.title, input.description, input.project, input.priority, input.date);
    Object(_storage_js__WEBPACK_IMPORTED_MODULE_0__["addTask"])(task, input.project);
    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["hideOverlay"])();
    setTimeout(function () {
      Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["removeNode"])(form);
    }, 150);
  } else if (formName === 'edit-task') {
    Object(_storage_js__WEBPACK_IMPORTED_MODULE_0__["editTask"])(form);
    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["hideOverlay"])();
    setTimeout(function () {
      Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["removeNode"])(form);
    }, 150);
...
function handleCancel(form) {
  ...
  if (formName === 'project-form') {
    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["removeNode"])(form);
    Object(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["showElement"])(_domManipulation_js__WEBPACK_IMPORTED_MODULE_1__["elements"].newProjectBtn);
...
/* harmony import */ var _taskController_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./taskController.js */ "./src/taskController.js");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var ProjectFactory = function ProjectFactory(projectName) {
...
/*!************************!*\
  !*** ./src/storage.js ***!
  \************************/
/*! exports provided: getProjects, addProject, getProjectAtIndex, getProjectByName, editProject, removeProject, getAllTasks, getProjectTasks, addTask, editTask, removeTask */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getProjectAtIndex", function() { return getProjectAtIndex; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getProjectByName", function() { return getProjectByName; });
...
/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! pubsub-js */ "./node_modules/pubsub-js/src/pubsub.js");
/* harmony import */ var pubsub_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(pubsub_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _formController_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./formController.js */ "./src/formController.js");
...
(function loadAllTasks() {
  if (!localStorage.length) {
    var general = Object(_projectController_js__WEBPACK_IMPORTED_MODULE_0__["default"])("All tasks");
    addProject(general);
  }
})();
...
function updateStorage(projectsArr) {
  ...
  pubsub_js__WEBPACK_IMPORTED_MODULE_2___default.a.publish("Update storage");
} // PROJECTS
...
function getProjectAtIndex(index) {
  var storedProjects = getProjects();
  var currentProject = storedProjects[index];
  return currentProject;
}
function getProjectByName(projectName) {
  var storedProjects = getProjects();
  var currentProject = storedProjects.find(function (project) {
...
function editProject(index, newName) {
  var storedProjects = getProjects();
  var editedProject = storedProjects[index];
  editedProject.name = newName;
  editedProject.tasks.forEach(function (task) {
...
function getAllTasks() {
  var storedProjects = getProjects();
  var storedTasks = [];
  storedProjects.map(function (project) {
...
function getProjectTasks(index) {
  if (index === 0) {
    var allTasks = getAllTasks();
    return allTasks;
  }

  var currentProject = getProjectAtIndex(index);
  return currentProject.tasks;
}
function addTask(task, project) {
  var storedProjects = getProjects();
  var currentProject = storedProjects.find(function (nextProject) {
    return nextProject.name === project;
  });
...
function editTask(form) {
  ...
  var projectRegex = /(?<=^P).*(?=I\d+$)/gm;
  var origProject = form.id.match(projectRegex).join();
  var indexRegex = /(?<=I)\d+$/gm;
  var origTaskIndex = Number(form.id.match(indexRegex).join());
  removeTask(origProject, origTaskIndex); // create new task with the same index

  var input = Object(_formController_js__WEBPACK_IMPORTED_MODULE_3__["getFormInput"])(form.name);
  var editedTask = Object(_taskController_js__WEBPACK_IMPORTED_MODULE_1__["default"])(input.title, input.description, input.project, input.priority, input.date, origTaskIndex);
  addTask(editedTask, input.project);
}
function removeTask(projectName, removedTaskIndex) {
  var storedProjects = getProjects();
  var currentProject = storedProjects.find(function (nextProject) {
    return nextProject.name === projectName;
  });
  var index = currentProject.tasks.findIndex(function (task) {
    return task.index === removedTaskIndex;
  });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
var TaskFactory = function TaskFactory(taskTitle, taskDescr, taskProject, taskPriority, taskDate) {
  var taskIndex = arguments.length > 5 && arguments[5] !== undefined ? arguments[5] : null;
  var title = taskTitle;
  var description = taskDescr;
  var project = taskProject;
  var priority = Number(taskPriority);
  var dueDate = taskDate;
  var index = taskIndex || Date.now();
  return {
    title: title,
